// Command generate-models reads pi-coding-agent's models.generated.js and emits
...
func generateGoSource(models map[string]map[string]modelEntry, total int) string {
	...
	b.WriteString("// Code generated by scripts/generate-models.go from @earendil-works/pi-coding-agent. DO NOT EDIT.\n")
	b.WriteString("//\n")
...
func findModelsJS() string {
	candidates := []string{
		"node_modules/@earendil-works/pi-coding-agent/dist/models.generated.js",
		"/usr/local/lib/bun/install/global/node_modules/@earendil-works/pi-coding-agent/dist/models.generated.js",
	...
	if exe, err := os.Executable(); err == nil {
		...
		candidates = append(candidates,
			filepath.Join(dir, "..", "node_modules", "@earendil-works", "pi-coding-agent", "dist", "models.generated.js"),
