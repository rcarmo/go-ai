...
// Generated: 2026-09-16T21:36:12Z
...
var builtinModels = []Model{
	...
	},
	{
		...
		AnthropicCompat:  &AnthropicMessagesCompat{ForceAdaptiveThinking: boolPtr(true), AllowedFallbackModels: []AnthropicAllowedFallbackModel{{Provider: Provider("anthropic"), Model: "claude-opus-4-8", Cost: ModelCost{Input: 5, Output: 25, CacheRead: 0.5, CacheWrite: 6.25}}, {Provider: Provider("anthropic"), Model: "claude-opus-5", Cost: ModelCost{Input: 5, Output: 25, CacheRead: 0.5, CacheWrite: 6.25}}}, SupportsStrictTools: boolPtr(true)},
		Reasoning:        true,
		ThinkingLevelMap: map[ModelThinkingLevel]*string{"max": strPtr("max"), "off": nil, "xhigh": strPtr("xhigh")},
		Input:            []string{"text", "image"},
		Cost:             ModelCost{Input: 10, Output: 50, CacheRead: 1, CacheWrite: 12.5},
	...
	},
	{
		...
		Provider:         "anthropic",
		BaseURL:          "https://api.anthropic.com",
		AnthropicCompat:  &AnthropicMessagesCompat{ForceAdaptiveThinking: boolPtr(true), SupportsMidConvoEffort: boolPtr(true), SupportsStrictTools: boolPtr(true)},
		Reasoning:        true,
		ThinkingLevelMap: map[ModelThinkingLevel]*string{"max": strPtr("max"), "off": nil, "xhigh": strPtr("xhigh")},
		Input:            []string{"text", "image"},
		Cost:             ModelCost{Input: 10, Output: 50, CacheRead: 0.25, CacheWrite: 12.5},
	...
	},
	{
		...
		Provider:         "anthropic",
		BaseURL:          "https://api.anthropic.com",
		AnthropicCompat:  &AnthropicMessagesCompat{SupportsTemperature: boolPtr(false), ForceAdaptiveThinking: boolPtr(true), SupportsMidConvoEffort: boolPtr(true), SupportsStrictTools: boolPtr(true)},
		Reasoning:        true,
		ThinkingLevelMap: map[ModelThinkingLevel]*string{"max": strPtr("max"), "off": nil, "xhigh": strPtr("xhigh")},
		Input:            []string{"text", "image"},
		Cost:             ModelCost{Input: 5, Output: 25, CacheRead: 0.5, CacheWrite: 6.25},
	...
	},
	{
		...
		CompletionsCompat: &OpenAICompletionsCompat{SupportsStore: boolPtr(false), SupportsDeveloperRole: boolPtr(false), SupportsReasoningEffort: boolPtr(false), MaxTokensField: "max_tokens", RequiresReasoningContentOnAssistantMessages: boolPtr(true), ThinkingFormat: "deepseek", SupportsStrictMode: boolPtr(false), SendSessionAffinityHeaders: boolPtr(true), SupportsLongCacheRetention: boolPtr(false)},
		Reasoning:         true,
	...
	},
	{
		...
		CompletionsCompat: &OpenAICompletionsCompat{SupportsStore: boolPtr(false), SupportsDeveloperRole: boolPtr(false), RequiresReasoningContentOnAssistantMessages: boolPtr(true), ThinkingFormat: "deepseek", SendSessionAffinityHeaders: boolPtr(true), SupportsLongCacheRetention: boolPtr(false)},
		Reasoning:         true,
		ThinkingLevelMap:  map[ModelThinkingLevel]*string{"high": strPtr("high"), "low": nil, "max": strPtr("max"), "medium": nil, "minimal": nil},
		Input:             []string{"text"},
		Cost:              ModelCost{Input: 0.44, Output: 1.32, CacheRead: 0.014, CacheWrite: 0},
	...
	},
	{
		...
		CompletionsCompat: &OpenAICompletionsCompat{SupportsStore: boolPtr(false), SupportsDeveloperRole: boolPtr(false), SendSessionAffinityHeaders: boolPtr(true), SupportsLongCacheRetention: boolPtr(false)},
		Reasoning:         true,
		ThinkingLevelMap:  map[ModelThinkingLevel]*string{"high": nil, "low": strPtr("low"), "max": nil, "medium": strPtr("medium"), "minimal": nil, "off": nil, "xhigh": strPtr("xhigh")},
		Input:             []string{"text", "image"},
		Cost:              ModelCost{Input: 0.45, Output: 3.2, CacheRead: 0.05, CacheWrite: 0},
		ContextWindow:     262144,
		MaxTokens:         262144,
	...
	},
	{
		...
		CompletionsCompat: &OpenAICompletionsCompat{SupportsStore: boolPtr(false), SupportsDeveloperRole: boolPtr(false), SupportsReasoningEffort: boolPtr(false), MaxTokensField: "max_tokens", RequiresReasoningContentOnAssistantMessages: boolPtr(true), ThinkingFormat: "deepseek", SupportsStrictMode: boolPtr(false), SupportsLongCacheRetention: boolPtr(false)},
		Reasoning:         true,
		ThinkingLevelMap:  map[ModelThinkingLevel]*string{"high": strPtr("high"), "low": nil, "max": strPtr("max"), "medium": nil, "minimal": nil},
		Input:             []string{"text"},
		Cost:              ModelCost{Input: 0, Output: 0, CacheRead: 0, CacheWrite: 0},
	...
	},
	{
		...
		BaseURL:          "https://opencode.ai/zen/v1",
		Reasoning:        true,
		ThinkingLevelMap: map[ModelThinkingLevel]*string{"high": strPtr("high"), "low": strPtr("low"), "max": strPtr("max"), "medium": strPtr("medium"), "minimal": strPtr("minimal"), "off": nil, "xhigh": strPtr("xhigh")},
		Input:            []string{"text", "image"},
		Cost:             ModelCost{Input: 1.25, Output: 4.25, CacheRead: 0.15, CacheWrite: 0},
		ContextWindow:    1048576,
		MaxTokens:        131072,
	...
	},
	{
		...
		CompletionsCompat: &OpenAICompletionsCompat{SupportsStore: boolPtr(false), SupportsDeveloperRole: boolPtr(false), MaxTokensField: "max_tokens"},
		Reasoning:         true,
		ThinkingLevelMap:  map[ModelThinkingLevel]*string{"high": strPtr("high"), "low": nil, "max": nil, "medium": nil, "minimal": nil, "off": strPtr("none"), "xhigh": nil},
		Input:             []string{"text"},
	...
	},
	{
		...
		CompletionsCompat: &OpenAICompletionsCompat{SupportsStore: boolPtr(false), SupportsDeveloperRole: boolPtr(false), MaxTokensField: "max_tokens"},
		Reasoning:         true,
		ThinkingLevelMap:  map[ModelThinkingLevel]*string{"high": strPtr("high"), "low": strPtr("low"), "max": nil, "medium": nil, "minimal": nil, "off": nil, "xhigh": nil},
		Input:             []string{"text", "image"},
	...
	},
	{
		...
		Provider:         "openrouter",
		BaseURL:          "https://openrouter.ai/api",
		AnthropicCompat:  &AnthropicMessagesCompat{ForceAdaptiveThinking: boolPtr(true), SupportsMidConvoEffort: boolPtr(true)},
		Reasoning:        true,
		ThinkingLevelMap: map[ModelThinkingLevel]*string{"high": strPtr("high"), "low": strPtr("low"), "max": strPtr("max"), "medium": strPtr("medium"), "minimal": nil, "off": nil, "xhigh": strPtr("xhigh")},
		Input:            []string{"text", "image"},
		Cost:             ModelCost{Input: 10, Output: 50, CacheRead: 0.25, CacheWrite: 12.5},
	...
	},
	{
		...
		AnthropicCompat:  &AnthropicMessagesCompat{ForceAdaptiveThinking: boolPtr(true)},
		Reasoning:        true,
		ThinkingLevelMap: map[ModelThinkingLevel]*string{"high": strPtr("high"), "low": strPtr("low"), "max": strPtr("max"), "medium": strPtr("medium"), "minimal": nil, "off": strPtr("none"), "xhigh": nil},
		Input:            []string{"text", "image"},
		Cost:             ModelCost{Input: 5, Output: 25, CacheRead: 0.5, CacheWrite: 6.25},
		ContextWindow:    1000000,
		MaxTokens:        128000,
	...
	},
	{
		...
		Provider:         "openrouter",
		BaseURL:          "https://openrouter.ai/api",
		AnthropicCompat:  &AnthropicMessagesCompat{SupportsTemperature: boolPtr(false), ForceAdaptiveThinking: boolPtr(true), SupportsMidConvoEffort: boolPtr(true)},
		Reasoning:        true,
		ThinkingLevelMap: map[ModelThinkingLevel]*string{"high": strPtr("high"), "low": strPtr("low"), "max": strPtr("max"), "medium": strPtr("medium"), "minimal": nil, "off": nil, "xhigh": strPtr("xhigh")},
		Input:            []string{"text", "image"},
		Cost:             ModelCost{Input: 5, Output: 25, CacheRead: 0.5, CacheWrite: 6.25},
	...
	},
	{
		...
		CompletionsCompat: &OpenAICompletionsCompat{SupportsDeveloperRole: boolPtr(false), ThinkingFormat: "openrouter"},
		Reasoning:         true,
		ThinkingLevelMap:  map[ModelThinkingLevel]*string{"high": strPtr("high"), "low": strPtr("low"), "max": nil, "medium": strPtr("medium"), "minimal": strPtr("minimal"), "off": strPtr("none"), "xhigh": nil},
		Input:             []string{"text", "image"},
		Cost:              ModelCost{Input: 0.25, Output: 2, CacheRead: 0, CacheWrite: 0},
		ContextWindow:     262144,
		MaxTokens:         131072,
	...
	},
	{
		...
		Reasoning:         true,
		ThinkingLevelMap:  map[ModelThinkingLevel]*string{"high": strPtr("high"), "low": nil, "max": nil, "medium": nil, "minimal": nil, "off": strPtr("none"), "xhigh": strPtr("xhigh")},
		Input:             []string{"text"},
		Cost:              ModelCost{Input: 0.08526, Output: 0.17052, CacheRead: 0.017052, CacheWrite: 0},
		ContextWindow:     1024000,
		MaxTokens:         384000,
	},
	{
	...
	},
	{
		...
		ThinkingLevelMap:  map[ModelThinkingLevel]*string{"high": strPtr("high"), "low": nil, "max": nil, "medium": nil, "minimal": nil, "off": strPtr("none"), "xhigh": strPtr("xhigh")},
		Input:             []string{"text"},
		Cost:              ModelCost{Input: 0.890358, Output: 1.780716, CacheRead: 0.074196, CacheWrite: 0},
		ContextWindow:     1024000,
		MaxTokens:         384000,
	},
	{
		...
		ThinkingLevelMap:  map[ModelThinkingLevel]*string{"high": strPtr("high"), "low": nil, "max": nil, "medium": nil, "minimal": nil, "off": strPtr("none"), "xhigh": strPtr("xhigh")},
		Input:             []string{"text"},
		Cost:              ModelCost{Input: 1.12068, Output: 3.36204, CacheRead: 0.037356, CacheWrite: 0},
		ContextWindow:     1024000,
		MaxTokens:         384000,
	},
	{
	...
	},
	{
		...
		CompletionsCompat: &OpenAICompletionsCompat{SupportsDeveloperRole: boolPtr(false), ThinkingFormat: "openrouter"},
		Reasoning:         true,
		ThinkingLevelMap:  map[ModelThinkingLevel]*string{"high": nil, "low": strPtr("low"), "max": nil, "medium": strPtr("medium"), "minimal": nil, "off": strPtr("none"), "xhigh": nil},
		Input:             []string{"text"},
	...
	},
	{
		...
		CompletionsCompat: &OpenAICompletionsCompat{SupportsDeveloperRole: boolPtr(false), ThinkingFormat: "openrouter"},
		Reasoning:         true,
		ThinkingLevelMap:  map[ModelThinkingLevel]*string{"high": strPtr("high"), "low": nil, "max": nil, "medium": strPtr("medium"), "minimal": nil, "off": strPtr("none"), "xhigh": nil},
		Input:             []string{"text"},
	...
	},
	{
		...
		CompletionsCompat: &OpenAICompletionsCompat{SupportsDeveloperRole: boolPtr(false), ThinkingFormat: "openrouter"},
		Reasoning:         true,
		ThinkingLevelMap:  map[ModelThinkingLevel]*string{"high": nil, "low": strPtr("low"), "max": nil, "medium": strPtr("medium"), "minimal": nil, "off": strPtr("none"), "xhigh": strPtr("xhigh")},
		Input:             []string{"text", "image"},
	...
	},
	{
		...
		CompletionsCompat: &OpenAICompletionsCompat{SupportsDeveloperRole: boolPtr(false), ThinkingFormat: "openrouter"},
		Reasoning:         true,
		ThinkingLevelMap:  map[ModelThinkingLevel]*string{"high": strPtr("high"), "low": nil, "max": strPtr("max"), "medium": nil, "minimal": nil, "off": nil, "xhigh": strPtr("xhigh")},
		Input:             []string{"text", "image"},
		Cost:              ModelCost{Input: 5, Output: 30, CacheRead: 0.5, CacheWrite: 0},
		ContextWindow:     1000000,
		MaxTokens:         128000,
	...
	},
	{
		...
		CompletionsCompat: &OpenAICompletionsCompat{SupportsDeveloperRole: boolPtr(false), ThinkingFormat: "openrouter"},
		Reasoning:         true,
		ThinkingLevelMap:  map[ModelThinkingLevel]*string{"high": strPtr("high"), "low": strPtr("low"), "max": strPtr("max"), "medium": strPtr("medium"), "minimal": strPtr("minimal"), "off": strPtr("none"), "xhigh": nil},
		Input:             []string{"text", "image"},
		Cost:              ModelCost{Input: 1, Output: 4.05, CacheRead: 0.17, CacheWrite: 0},
		ContextWindow:     524288,
		MaxTokens:         471859,
	...
	},
	{
		...
		ThinkingLevelMap:  map[ModelThinkingLevel]*string{"high": strPtr("high"), "low": strPtr("low"), "max": strPtr("max"), "medium": nil, "minimal": nil, "off": strPtr("none"), "xhigh": nil},
		Input:             []string{"text", "image"},
		Cost:              ModelCost{Input: 2.55, Output: 12.75, CacheRead: 0.256, CacheWrite: 0},
		ContextWindow:     1048576,
		MaxTokens:         131072,
	},
	{
	...
	},
	{
		...
		ThinkingLevelMap: map[ModelThinkingLevel]*string{"xhigh": strPtr("xhigh")},
		Input:            []string{"text", "image"},
		Cost:             ModelCost{Input: 4, Output: 24, CacheRead: 0.4, CacheWrite: 5},
		ContextWindow:    1050000,
		MaxTokens:        128000,
	},
	{
	...
	},
	{
		...
		ThinkingLevelMap: map[ModelThinkingLevel]*string{"xhigh": strPtr("xhigh")},
		Input:            []string{"text", "image"},
		Cost:             ModelCost{Input: 20, Output: 100, CacheRead: 2, CacheWrite: 25},
		ContextWindow:    1050000,
		MaxTokens:        128000,
	},
	{
