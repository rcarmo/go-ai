...
- Full local gates passed: `make check`, shuffle, race, vet, staticcheck, logging, repro, SBOM, vuln, and license. Clean-checkout validation passed with `go test ./...`, v0.85.1 inventory/catalog/manifest validators and self-tests, model-regeneration negative self-test, exact regeneration comparators, and `git diff --check`. Accepted runtime `9c32e1d77bb01bac4574c6ecf260ce07bac9a351` passed hosted CI `35154293042` (jobs `104989912357` fuzz and `104989912650` vet/staticcheck/deterministic/race/coverage/logging). SBOM artifact `10470163191` validates: archive SHA-256 `47ee0b0a9d947f525cd6f58b9aa05ac8d1fecbc54406a7d1b82a40ad4622f7e4`, inner SBOM SHA-256 `7f551d8c93a67cf40e32bdd793d5b56c9e43c2b0fd6c55cad47e1bc2e0d063f3`, checksum-file SHA `723487ea76b0b8e244e2e2b510cd1ce43e36bbd9c90bfc6aeb661ca5d5004c93`, root version `9c32e1d77bb0`. README/SBOM release publication authorized post-runtime.
