...
| --- | --- | --- |
| `packages/ai/src/models.generated.ts` — 1,057 chat models across 35 providers | `models_generated.go`, `models_catalog_upstream_test.go` | Regenerated from `2b3fda9`; diff against generated output is timestamp-only. |
...
| `packages/ai/src/utils/estimate.ts` / cost tiers | `context.go`, `v0806_parity_test.go`, `estimate_upstream_test.go`, `tokens_simulated_test.go`, `total_tokens_simulated_test.go` | Deterministic parity covered, including v0.80.6 highest matching cost tier and prefix-anchor context estimation. |
