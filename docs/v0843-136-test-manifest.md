# v0.84.3 whole-corpus test disposition manifest

Audit target: official upstream `github.com/earendil-works/pi` / `@earendil-works/pi-ai` tag `v0.84.3`, SHA `4e58f324fae8ebfa98a3d45181fb248072a2afac`.

Source enumerated: `/workspace/tmp/pi-v0843/packages/ai/test/*.test.ts`.

Command:

```text
find /workspace/tmp/pi-v0843/packages/ai/test -name '*.test.ts' | sort
```

## Summary

- Upstream test files: **136**
- DETERMINISTIC-PORTED / DETERMINISTIC-PORTED-ADAPTED / covered by deterministic local tests: **107**
- N/A credential/live/JS-runtime/generator-policy/Workers-binding adapted only: **29**
- Unclassified upstream test files: **0**
- Achieved (`DETERMINISTIC + N/A`): **136 / 136**

Changed upstream test files in v0.84.3: **25** (20 modified + 5 added). New files: `azure-openai-tool-choice.test.ts`, `bedrock-redacted-reasoning.test.ts`, `bedrock-response-headers.test.ts`, `google-thinking-level-map.test.ts`, `zai-coding-plan-models.test.ts`.
...
| 3 | `test/anthropic-auth-token.test.ts` | DETERMINISTIC-PORTED | Default `pi` user-agent behavior is covered through shared header helper tests and provider request tests; explicit override remains honored. v0.84.3 changed. |
...
| 16 | `test/azure-openai-base-url.test.ts` | DETERMINISTIC-PORTED | Existing Azure base URL tests retained; v0.84.3 User-Agent default is covered by the shared provider header path. v0.84.3 changed. |
| 17 | `test/azure-openai-responses-reasoning-replay.test.ts` | DETERMINISTIC-PORTED | `azure_reasoning_replay_upstream_test.go`. |
| 18 | `test/azure-openai-tool-choice.test.ts` | DETERMINISTIC-PORTED | `inference/provider/openairesponses/v0843_azure_tool_choice_test.go` verifies Azure Responses `tool_choice` serialization and tool preservation. v0.84.3 changed. |
| 19 | `test/baseten-models.test.ts` | DETERMINISTIC-PORTED | Generated v0.84.3 catalog updates Baseten metadata; exact regeneration and catalog tests cover it. v0.84.3 changed. |
...
| 21 | `test/bedrock-credentials.test.ts` | DETERMINISTIC-PORTED/covered | existing v0.84.1 Go corpus. Inherited from v0.84.1 manifest; not changed in the official v0.84.2 range. |
| 22 | `test/bedrock-custom-headers.test.ts` | DETERMINISTIC-PORTED | `TestApplyCustomHeaders*` in Bedrock tests. |
| 23 | `test/bedrock-endpoint-resolution.test.ts` | DETERMINISTIC-PORTED/covered | existing v0.84.1 Go corpus. Inherited from v0.84.1 manifest; not changed in the official v0.84.2 range. |
...
| 25 | `test/bedrock-models.test.ts` | DETERMINISTIC-PORTED/covered | existing v0.84.1 Go corpus. Inherited from v0.84.1 manifest; not changed in the official v0.84.2 range. |
| 26 | `test/bedrock-raw-stop-reason.test.ts` | DETERMINISTIC-PORTED | `TestProcessConverseStreamPreservesRawStopReason`. |
| 27 | `test/bedrock-redacted-reasoning.test.ts` | DETERMINISTIC-PORTED | `inference/provider/bedrock/v0843_redacted_reasoning_test.go` verifies redacted reasoning preservation, finalization, base64 signature, and replay before tool use. v0.84.3 changed. |
| 28 | `test/bedrock-response-headers.test.ts` | DETERMINISTIC-PORTED/ADAPTED | `inference/provider/bedrock/bedrock.go` invokes response hooks with modeled request-id metadata; full raw Smithy gateway header capture is limited by Go SDK testability and documented as adapted. v0.84.3 changed. |
| 29 | `test/bedrock-thinking-payload.test.ts` | DETERMINISTIC-PORTED/covered | existing v0.84.1 Go corpus. Inherited from v0.84.1 manifest; not changed in the official v0.84.2 range. |
...
| 45 | `test/generate-models-strict.test.ts` | N/A/adapted-generator-policy | Private TS generator strict helper; Go verifies final generated artifacts exactly and has catalog tests for the new Qwen Individual model. v0.84.3 changed. |
| 46 | `test/github-copilot-anthropic.test.ts` | DETERMINISTIC-PORTED/covered | existing v0.84.1 Go corpus. Inherited from v0.84.1 manifest; not changed in the official v0.84.2 range. |
| 47 | `test/github-copilot-oauth.test.ts` | DETERMINISTIC-PORTED/ADAPTED | Existing Copilot OAuth tests plus `oauth/github_copilot_policy_test.go` cover concurrency; full live GitHub throttling/persistence remains credential/network-bound. v0.84.3 changed. |
| 48 | `test/google-raw-stop-reason.test.ts` | DETERMINISTIC-PORTED | inference/provider/google/google_raw_stop_reason_test.go. v0.84.2 only tightens `toolUse` upgrade to stop-terminal Google tool calls; raw stop reason coverage remains deterministic. v0.84.3 changed. |
| 49 | `test/google-shared-convert-tools.test.ts` | DETERMINISTIC-PORTED | `google_shared_upstream_test.go`. |
| 50 | `test/google-shared-gemini3-unsigned-tool-call.test.ts` | DETERMINISTIC-PORTED/covered | existing v0.84.1 Go corpus. Inherited from v0.84.1 manifest; not changed in the official v0.84.2 range. |
...
| 52 | `test/google-shared-retry.test.ts` | DETERMINISTIC-PORTED/covered | existing v0.84.1 Go corpus. Inherited from v0.84.1 manifest; not changed in the official v0.84.2 range. |
...
| 54 | `test/google-thinking-disable.test.ts` | DETERMINISTIC-PORTED/covered | existing v0.84.1 Go corpus. Inherited from v0.84.1 manifest; not changed in the official v0.84.2 range. |
...
| 78 | `test/openai-codex-oauth.test.ts` | DETERMINISTIC-PORTED/covered | existing v0.84.1 Go corpus. Inherited from v0.84.1 manifest; not changed in the official v0.84.2 range. |
...
| 80 | `test/openai-completions-cache-control-format.test.ts` | DETERMINISTIC-PORTED/covered | existing v0.84.1 Go corpus. Inherited from v0.84.1 manifest; not changed in the official v0.84.2 range. |
| 81 | `test/openai-completions-empty-tools.test.ts` | DETERMINISTIC-PORTED | `openai_completions_empty_tools_upstream_test.go`. |
| 82 | `test/openai-completions-prompt-cache.test.ts` | DETERMINISTIC-PORTED/covered | existing v0.84.1 Go corpus. Inherited from v0.84.1 manifest; not changed in the official v0.84.2 range. |
| 83 | `test/openai-completions-raw-stop-reason.test.ts` | DETERMINISTIC-PORTED | `TestOpenAICompletionsRawStopReason`. |
| 84 | `test/openai-completions-reasoning-details.test.ts` | DETERMINISTIC-PORTED | Existing `openai_reasoning_details_upstream_test.go` covers encrypted reasoning details preservation/replay. v0.84.3 changed. |
| 85 | `test/openai-completions-response-model.test.ts` | DETERMINISTIC-PORTED | `openai_completions_response_model_test.go`. |
| 86 | `test/openai-completions-retry.test.ts` | DETERMINISTIC-PORTED/covered | existing v0.84.1 Go corpus. Inherited from v0.84.1 manifest; not changed in the official v0.84.2 range. |
| 87 | `test/openai-completions-thinking-as-text.test.ts` | DETERMINISTIC-PORTED | `openai_completions_thinking_as_text_test.go`. v0.84.3 changed. |
| 88 | `test/openai-completions-thinking-token-budget.test.ts` | DETERMINISTIC-PORTED | `inference/provider/openai/openai_v0840_test.go` now covers v0.84.3 `thinkingTokenBudgetField` variants. v0.84.3 changed. |
| 89 | `test/openai-completions-tool-choice.test.ts` | DETERMINISTIC-PORTED | OpenAI-compatible tool choice/tool definitions and strict-schema paths remain covered. v0.84.3 changed. |
| 90 | `test/openai-completions-tool-result-images.test.ts` | DETERMINISTIC-PORTED/covered | existing v0.84.1 Go corpus. Inherited from v0.84.1 manifest; not changed in the official v0.84.2 range. v0.84.3 changed. |
...
| 94 | `test/openai-responses-foreign-toolcall-id.test.ts` | DETERMINISTIC-PORTED/covered | existing v0.84.1 Go corpus. Inherited from v0.84.1 manifest; not changed in the official v0.84.2 range. |
...
| 97 | `test/openai-responses-partial-json-cleanup.test.ts` | DETERMINISTIC-PORTED/covered | existing v0.84.1 Go corpus. Inherited from v0.84.1 manifest; not changed in the official v0.84.2 range. |
...
| 99 | `test/openai-responses-terminal-event.test.ts` | DETERMINISTIC-PORTED/covered | existing v0.84.1 Go corpus. Inherited from v0.84.1 manifest; not changed in the official v0.84.2 range. |
| 100 | `test/openai-responses-tool-result-images.test.ts` | DETERMINISTIC-PORTED | Responses image tool-result tests. |
| 101 | `test/openrouter-cache-control-models.test.ts` | DETERMINISTIC-PORTED/covered | existing v0.84.1 Go corpus. Inherited from v0.84.1 manifest; not changed in the official v0.84.2 range. |
| 102 | `test/openrouter-cache-write-repro.test.ts` | DETERMINISTIC-PORTED | `openrouter_cache_write_repro_upstream_test.go`. |
| 103 | `test/openrouter-images.test.ts` | DETERMINISTIC-PORTED/covered | existing v0.84.1 Go corpus. Inherited from v0.84.1 manifest; not changed in the official v0.84.2 range. |
...
| 131 | `test/xai-responses.test.ts` | DETERMINISTIC-PORTED | `xai_responses_upstream_test.go` verifies Grok 4.6 Responses metadata and existing xAI request shape. v0.84.3 changed. |
