...
| `src/models.generated.ts`, `src/providers/*.models.ts` | `models_generated.go`, `models_test.go`, `models_catalog_upstream_test.go`, `scripts/generate-models.go`, `scripts/compare-upstream-models.py` | Implemented mechanically. Header, tests, and direct upstream-map comparator verify 1057 models / 35 providers and spot-check changed v0.80.6 metadata without copying another port. |
