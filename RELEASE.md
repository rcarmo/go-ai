...
- Candidate `fcd8270faee46a2eead7ef13e054f96704791ff4` and CI run `33890620670` are superseded/rejected. Candidates `c2d5d318c4e3052502c784255b856e1a7a12914b` / CI `33893048444` and `dc523a42ca530bbcb3cf0300e8f80808914a39d2` / CI `33894031330` are superseded by the final frame wire-fidelity correction. Final presence/decode local gates passed: `make check`, shuffle, race, vet, staticcheck, logging, repro, SBOM, vuln, and license. Final presence/decode clean-checkout validation passed with `go test ./...`, committed inventory validation/self-test, catalog delta validation/self-test, 142-row manifest validation, model/image regeneration comparators, and `git diff --check`. SHA-linked SBOM/hosted CI will be rerun after the final presence/decode commit.
